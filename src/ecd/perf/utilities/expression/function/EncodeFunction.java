...
/**
 * Convert the parameter comes after transform id from binary content to hexadecimal string
 * @since 2.1.0
 */
public class EncodeFunction extends CustomFunction
{
	@Override
	public String getId()
	{
		return "encode"; //$NON-NLS-1$
	}
	...
	public String translate(List<String> paraValues, Map<String,String> encodeOptions) {
		return "${__urlencode("+translateWithEscapeParam(paraValues.get(0))+")}";
	}
}
