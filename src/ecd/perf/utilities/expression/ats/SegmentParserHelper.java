...
public class SegmentParserHelper {
   ...
   //concurrent hash map causes NPE when a lot of VUSErs run a lot of iterations
	...
	private final static  SegmentParserHelper g_instance = new SegmentParserHelper();;
	private final Object mapLock = new Object();

	private SegmentParserHelper()
	{
	}
	
	public static SegmentParserHelper getInstance()
	{		
		return g_instance;
	}
	
	public Segment parse(String input, final HashMap<String, CSVDataSet> databanks) throws Exception
	{
		if(input == null)
			return null;
		synchronized(mapLock){
		  ...
		  Segment parsedSegment = SegmentParser.parse(input, databanks);			
